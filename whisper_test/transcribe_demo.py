...
def main():
    ...
    parser.add_argument("--phrase_timeout", default=1, type=float)
    ...
    while True:
        try:
            ...
            if not data_queue.empty():
                ...
                if phrase_time is not None and now - phrase_time > timedelta(seconds=args.phrase_timeout):
